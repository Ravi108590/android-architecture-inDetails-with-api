...
public class FragmentFrameHelper {
    ...
    public void navigateUp() { // navigator which present on ActionBar(like-backPress)
        ...
        // by pressing the back button it's entry count becomes 1>0 and it removes the current fragment
        ...
        // frame (Parent) has multiple fragment(child)
