...
public class ToolbarViewMvc extends BaseViewMvc {
    ...
    public interface NavigateUpClickListener {
        void onNavigateUpClicked(); // when back button clicked , questionViewMvc simply passes this event controller
    }
   ...
   public void setTitle(String title) {
    ...
    // hamBurger and app button should not show together , checking that violation
