...
public class QuestionDetailsFragment extends BaseFragment implements
    ...
    // Stores the data of the details fragment to display
    // stores the data of the particular Fragment into the bundle and shows into the fragment
    ...
    // on Close break the dialog and on retry start fetching question details if net in on
    @Override
    ...
    @Override
    public void userInfoDialog(String name, String url) {
        mDialogsManager.userInfoDialog(null, name, url);
    }
