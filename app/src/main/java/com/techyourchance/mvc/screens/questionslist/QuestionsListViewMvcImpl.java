...
public class QuestionsListViewMvcImpl extends BaseObservableViewMvc<QuestionsListViewMvc.Listener>
    ...
    public QuestionsListViewMvcImpl(LayoutInflater inflater,
        ...
        mAdapter = new QuestionsRecyclerAdapter(this, viewMvcFactory);// Adapter instantiated
...
// Initializes the tool bar(Action bar)
    ...
    // binds the questions from network (api) with List
    @Override
